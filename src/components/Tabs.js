...
export default function Tabs({tab, setTab}) {
    ...
    function commercialClick () {
        ...
        setP1('Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit quo,corporis sapiente quos deserunt id non quis aut eligendi molestiaefacere quaerat temporibus dignissimos aliquid, repellendus similiquemollitia dolorem recusandae, ab laudantium. Quisquam, numquam. Loremipsum dolor sit amet consectetur. Lorem ipsum, dolor sit ametconsectetur adipisicing elit. Id, ea.')
        setH2('Get our Commercial Locksmith Services Now')
        setP2('Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque, ducimus.')
    ...
    return (
        ...
        <div id="tabs">
            <ul className='remove_list_style'>
                <li onClick={() => commercialClick()} className={tab===1?'active-tab':'non-active-tab'}>Commercial Locksmith</li>
                <li onClick={() => residentialClick()} className={tab===2?'active-tab':'non-active-tab'}>Residential Lcoksmith</li>
                <li onClick={() => automotiveClick()} className={tab===3?'active-tab':'non-active-tab'}>Automotive Locksmith</li>
                <li onClick={() => emergencyClick()} className={tab===4?'active-tab':'non-active-tab'}>Emergency Lcoksmith</li>
            </ul>
        </div>
        <Service h1={h1} h2={h2} p1={p1} p2={p2} tab={tab} service={service} imgSrc={imgSrc} />
        </>
    )
}
